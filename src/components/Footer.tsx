    ...
    <footer className="border-t border-[var(--border)] bg-[var(--surface)]">
      <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 lg:py-16">
        <div className="flex flex-col gap-9 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-lg font-semibold tracking-[-0.025em]">mikitylife<span className="text-[var(--accent)]">.</span></p>
            <p className="mt-3 text-xs tracking-[0.04em] text-[var(--muted)]">Work. Train. Learn. Live.</p>
          </div>
